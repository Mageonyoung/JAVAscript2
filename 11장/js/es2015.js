...
//전개 구문 ... 변수명
// 나머지 매개 변수로 사용할 때
//매개변수를 고정하기 어려운 경우에 전개 구문으로 변수 하나 지정
...
//[]표기법을 사용하면 가능 []안에는 문자열로 작성해야 함.
book["punlish date"] = "2023-11"
console.log("book:", book);

//ES2015부터 함수나 계산식을 프로퍼티 이름으로 사용가능
function fn(){
    return "result"; //함수의 리턴 값이 프로퍼티로 사용
}
const obj1 ={
...
// 변수에 지정된 값으 프로퍼티로 사용해야 할 경우기 있다
//프롬프트 창으로 입력 받아그 값을 프로퍼티로 사용하는 경우
//이때 생성자 함수로 객체를 저으이하여 사용할 수있다.
...
let user1 = makeUser ("마건영",23)
console.log("user1 : ",user1)
/*
    프로퍼티 단축 표기법 =>name : name
    객체 리터럴에서 사용.
    직접할당. 주로 단단한 객체 초기화에 사용
    this.name =neme
    생성자 함수 내부에서 사용됨
...
let user2 =makeUser ("마건영",23)
console.log("user2 : ",user2)

//객체에서 심벌키 사용.
//symbol =>ES2015이후에추가된 원시 자료형
//한번 정의하면 값을 변경 할 수없다.
...
//심벌을 만들 때마다 유일한 값을 가진다
//상황에 따라 만든 심벌은 다른 곳에서 사용해야 할 경우가 있다
//여러곳에서 같이 사용할 수 있는 심벌을 전역 심벌이라고한다
// symbol.for()메서드
